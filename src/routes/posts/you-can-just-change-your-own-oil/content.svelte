<div class="prose mx-auto">
	...
	<p>
		...
		called an oil pan. Somewhere on the oil pan is a drain that is kept plugged
		with a small drain plug bolt. Removing the drain plug bolt requires a socket
		wrench. The socket size required to fit the drain plug bolt is not
		universal. Any socket wrench set will include a socket that fits your drain
		plug.
	</p>
	<p>
	...
	<p>
		The oil filter housing and oil pan are usually not accessible without first
		lifting your car. There are two inexpensive methods for lifting your
		vehicle.
	</p>
	...
	<p>
		A hydraulic floor jack is the easiest way to elevate your vehicle. The only
		tricky part is finding your car's lift points but you only have to do this
		once. The lift point location can usually be found in your vehicle's owner's
		manual. Googling '<strong><strong>*</strong></strong>your car year, make,
		model<strong><strong>*</strong></strong> jack point' will also work. Once your
		car is elevated jack stands must be placed under the frame to catch your car
		if the jack fails and wheel chocks placed behind the wheels to prevent your car
	...
	<p>
		...
		weight of your vehicle. Many inexpensive floor jacks on amazon are rated for
		only 1.5 tons which will not lift a standard sedan. A standard sedan will
		usually weigh around 2 tons and trucks will weigh anywhere between 2 and 4
		tons. A low-set car may require a specialized low profile hydraulic floor
		jack.
	</p>
	<p>
		...
		advantage over wheel ramps is that they can be used to elevate your car with
		the wheels removed for work on brake and wheel maintenance tasks. Hydraulic
	...
	<p>
		...
		oil. The most hassle-free method is to use a combined oil collection and
		storage container like the one pictured below. Waste oil is collected
	...
	<p>
		...
		oil pans will likely be insufficient to hold two oil changes worth of waste
		oil and will necessitate disposal after every oil change.
	</p>
	<p>
		<a
	...
	<p>
		...
		different locations and orientations. Different tools are required depending
		on the vehicle.
	</p>
	<p>
	...
	<p>
		...
		likely have your vehicle's oil filter on the shelf. Do not buy your oil
	...
	<p>
		...
		leverage on a bolt. It's unlikely that you will require a breaker bar for an
		oil change. However, some less conscientious auto mechanics may have
	...
	<p>
		...
		positioned to account for the trajectory of the draining oil. A good way to
		control the flow of oil is to keep the drain plug bolt pressed against the
		oil pan while you're unscrewing it. This will prevent the oil from dripping
		over your arms and tools.
	</p>
	<p>
		The oil will initially come out very quickly and eventually slow to a drip.
		You should wait until all the oil has been emptied before putting the drain
		plug bolt back on. The oil filter can be replaced while waiting for the oil
		pan to drain.
	</p>
	...
	<p>
		...
		packaged with the filter. Most oil filter kits will include a rubber O-ring
		used to maintain a seal between the oil filter housing and your vehicle.
		Find these parts on your old filter once removed and replace them with the
		new ones.
	</p>
	<p>
		Keep in mind that the filter will be saturated in oil and care should be
		taken that it won't spill when being removed. Oil will drain from where the
		filter housing was removed but this should subside before the oil pan has
		been drained.
	</p>
	<h3 id="4-re-plug-oil-pan">4. Re-Plug Oil Pan</h3>
	<p>
		Return the oil drain plug bolt back into the oil pan. Tighten the bolt using
		your socket wrench until you meet resistance plus one little shove.
	</p>
	...
	<p>
		Your car will have a rod used to test the oil level of your vehicle called a
		dipstick. You can usually find the dipstick by looking for a yellow ring
		somewhere in the engine bay.
	</p>
	<p>
		The bottom of the dipstick sits partway inside the oil tank and will have
		markings indicating the recommended oil level. Before checking your engine's
		oil level see if your owner's manual recommends checking after running the
		engine or if it can be checked cold. Also make sure your car is level and no
		longer elevated.
	</p>
	<h1 id="misc">Misc</h1>
	...
	<p>
		Occasionally you will encounter a bolt that will not break loose. Before you
		try pulling even harder consider the damage you may be doing to the head of
		the bolt. Applying too much force to the head of a bolt may begin to round
		the edges making it even more difficult to remove. Taking your car to an
		auto shop and having a professional remove the stuck bolt is usually the
