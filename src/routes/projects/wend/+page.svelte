<script>
	import FrontEnd from './stack_sections/FrontEnd.svelte';
	import BackEnd from './stack_sections/BackEnd.svelte';
	import DevOps from './stack_sections/DevOps.svelte';
	import Intro from './stack_sections/Intro.svelte';
